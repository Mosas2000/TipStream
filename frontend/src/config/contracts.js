...
export const CONTRACT_NAME = 'tipstreams';
...
// Explorer links
export const CONTRACT_EXPLORER_URL = `https://explorer.hiro.so/txid/SP1W6XQZ6XVYGTVW32SJW2ZG48ZJBW9BATRD19N60.tipstreams?chain=mainnet`;
