...
export function exportToCsv() {
  ...
  const rows = [
    ...
    ['Batch Tips Started', summary.batchTipsStarted],
    ['Batch Tips Confirmed', summary.batchTipsConfirmed],
    ['Batch Completion Rate', `${summary.batchCompletionRate}%`],
    ['Average Batch Size', summary.averageBatchSize],
