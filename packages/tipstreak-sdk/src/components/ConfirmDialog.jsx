/**
 * @module tipstreak-sdk/components/ConfirmDialog
 *
 * Accessible modal confirmation dialog with focus trapping and keyboard support.
 ...
 * >
 *   Are you sure you want to send 1 STX?
 * </ConfirmDialog>
 */
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div
        ...
        className="relative bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-700 p-6 max-w-md w-full mx-4"
      >
        <h3
